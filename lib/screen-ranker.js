 ...
 */
function isEdgePlausible({ consensusEdge, consensusBookCount, targetOdds, bestAvailableOdds } = {}) {
  if (!Number.isFinite(consensusEdge)) return true; // null/NaN edge: not our concern
  if (consensusBookCount != null && consensusBookCount < 2) return false; // thin/phantom consensus
