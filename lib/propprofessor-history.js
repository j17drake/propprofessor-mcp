...
async function resolveHistoryForEntity({ client, target, rows, queryHistoryFn, lookbackHours = 12, nowMs = Date.now() }) {
  ...
  const payload = await queryHistoryFn({ gameId, selectionId, sportsbooks: [], startTimestamp });
