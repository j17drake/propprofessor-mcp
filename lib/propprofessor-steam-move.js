...
const SHARP_BOOKS = [
  'Pinnacle', 'Circa', 'BookMaker', 'BetOnline', 'Bet365',
...
function detectSteamMove(row, options = {}) {
  ...
  const supportive = pickSide
    ? isSupportiveDirection(dominantDirection, pickSide)
    : true; // No pick side specified, any multi-book movement is steam
