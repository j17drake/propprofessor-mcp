...
function parseNaturalLanguagePropQuery(text) {
  ...
  const bookKeywords = [
    'novig', 'novigapp', 'no vig', 'novig',
    'fanduel', 'draftkings', 'betmgm', 'caesars', 'pointsbet', 'bet365',
    'betonline', 'betrivers', 'barstool', 'foxbet', 'wynnbet', 'hardrock',
    'pinnacle', 'circa', 'bookmaker', 'prophet exchange', 'prophet',
    'fliff', 'rebet', 'chamba', 'vivid picks',
    'thescore', 'prizepicks', 'underdog',
  ];
  ...
  if (foundBook && !book) {
    const bookMap = {
      'novig': 'NoVigApp', 'novigapp': 'NoVigApp', 'no vig': 'NoVigApp',
      'pinnacle': 'Pinnacle',
      'fanduel': 'FanDuel', 'draftkings': 'DraftKings',
      'betmgm': 'BetMGM', 'betonline': 'BetOnline',
      'circa': 'Circa', 'bookmaker': 'BookMaker',
      'fliff': 'Fliff', 'rebet': 'Rebet',
