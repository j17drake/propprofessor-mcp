...
function buildToolDefinitions() {
  ...
  return [
    ...
    },
    {
      ...
      description: 'Clear the score timeline cache used for tier trajectory tracking. Resets all historical tier data. Use when starting a new session or after config changes.',
      inputSchema: { type: 'object', properties: {}, additionalProperties: false }
    },
    {
