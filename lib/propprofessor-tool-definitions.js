  ...
  return [
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          live: { type: 'boolean', description: 'Whether to query live +EV rows. Canonical name (preferred over "is_live").' },
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          live: { type: 'boolean', description: 'Whether to query live odds. Canonical name (preferred over "is_live").' },
          includeResearch: {
            type: 'boolean',
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          live: { type: 'boolean', description: 'Whether to query live plays. Canonical name (preferred over "is_live").' },
          periodTypes: {
            type: 'array',
            items: { type: 'string' },
