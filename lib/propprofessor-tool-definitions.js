...
function buildToolDefinitions() {
  ...
  const HONEST_SCOPE_CAVEAT =
    ' SIGNAL-QUALITY RATING, NOT WIN PROBABILITY: tier/kaiCall/edge/screenScore are quality ratings on what sharp books are doing (line moves, consensus, steam). They do NOT predict which side will win. TIER 1 means sharp books agree, not that the side will win. Use to inform handicapping, not to outsource decisions.';
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          isLive: { type: 'boolean', description: 'Whether to query live plays.' },
          periodTypes: {
            type: 'array',
            items: { type: 'string' },
