...
function buildToolDefinitions({ mode = 'full' } = {}) {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          books: {
            ...
            items: { type: 'string' },
            description:
              'Alias for targetBooks. Use either books or targetBooks — both work.'
          },
          targetBooksCsv: {
            type: 'string',
            description:
          ...
          targetBook: {
            type: 'string',
            description:
              'Legacy alias for book. Deprecated — prefer "targetBooks" array. Still accepted.'
          },
          leagues: {
            type: 'array',
            items: { type: 'string' },
  ...
  ].sort((a, b) => (a.name < b.name ? -1 : a.name > b.name ? 1 : 0)).map((tool) => ({
    ...tool,
