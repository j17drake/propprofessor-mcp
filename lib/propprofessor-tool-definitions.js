  ...
  return [
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          confidenceTier: { type: 'string', description: 'Optional confidence tier from recommended_bets or novig_screen' },
    ...
    },
    {
      ...
      inputSchema: {
        type: 'object',
        properties: {
          status: { type: 'string', enum: ['pending', 'won', 'lost', 'push', 'all'], description: 'Filter by result status. Default: all.' },
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          lookbackHours: { type: 'number', description: 'How far back to scan for movement. Default: 6, min: 1, max: 48.' },
          minSteamBooks: { type: 'number', description: 'Minimum sharp books agreeing for a steam alert. Default: 2, max: 5.' }
        },
        additionalProperties: false
      }
    }
