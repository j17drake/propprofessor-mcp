...
const PLAYER_CIRCUIT = {
  ...
  Bertola: { tour: 'atp', preferredSlugs: ['eastbourne', 'wimbledon'] },
  Basing: { tour: 'atp', preferredSlugs: ['eastbourne', 'wimbledon'] },
  Choinski: { tour: 'atp', preferredSlugs: ['eastbourne', 'wimbledon'] },
  Marozsan: { tour: 'atp', preferredSlugs: ['mallorca', 'halle', 'wimbledon'] },
  Mochizuki: { tour: 'atp', preferredSlugs: ['eastbourne', 'wimbledon'] },
};
