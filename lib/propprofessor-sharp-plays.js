...
function classifySharpPlay(row = {}, options = {}) {
  ...
  if (!consensusOk && !isPropMarket && !alternativeBookCountsOk && !consensusEdgeOnlyOk) passReasons.push(`consensus_book_count_below_${minConsensusBookCount}`);
