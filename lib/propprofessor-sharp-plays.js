...
/**
 * Resolve league list from arguments, defaulting to ['NBA', 'MLB', 'NHL', 'Tennis', 'WNBA', 'UFC'].
...
function resolveSharpPlayLeagues(args = {}) {
  return uniqueBooks(
    normalizeList(args.leagues, args.league ? [args.league] : ['NBA', 'MLB', 'NHL', 'Tennis', 'WNBA', 'UFC'])
  );
}
