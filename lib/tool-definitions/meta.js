...
function buildMetaTools() {
  return [
    ...
    },
    {
      name: 'today',
      description:
        'FIRST CALL — daily briefing: the current sharp slate (top plays by consensus edge), pending picks, and betting stats. Replaces three calls. Then drill down with quick_screen for a specific sport.',
      inputSchema: {
        type: 'object',
