  ...
  return [
    {
      name: 'quick_screen',
      description:
        'One-call sharp-play scanner: target a book, scan all leagues × markets, get ranked results with player-context research and risk flags. Defaults to NoVigApp. PITFALL: first call is slow (multi-league fan-out). Repeat calls with same args hit cache and return instantly. For "just show me bets", use kaiCall:["BET"] or onlyBets:true.' +
        HONEST_SCOPE_CAVEAT,
      inputSchema: {
        type: 'object',
    ...
    },
    {
      name: 'smart_bet',
      description:
        'One-call bet evaluation: given a player/team and book, returns play details, validation verdict, best price across books, and staking recommendation. PITFALL: this is a convenience wrapper — it calls quick_screen, validate_play, and find_best_price internally. For bulk scanning, use quick_screen directly.' +
        HONEST_SCOPE_CAVEAT,
      inputSchema: {
        type: 'object',
