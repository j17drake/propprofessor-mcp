  ...
  return [
    {
      name: 'quick_screen',
      description:
        'SCAN — one-call sharp-play scanner across leagues × markets. Returns ranked results with tiers, edge, movement, and validation. For bets-only, use onlyBets:true.' +
        HONEST_SCOPE_CAVEAT,
      inputSchema: {
        type: 'object',
