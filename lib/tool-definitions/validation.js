  ...
  return [
    {
      name: 'ev_candidates',
      description:
        'Query the +EV endpoint and return candidate plays for enabled books. Secondary discovery tool.',
      inputSchema: {
        type: 'object',
    ...
    },
    {
      name: 'validate_play',
      description:
        'PRE-BET CHECK — run validation on a play. Returns BET/CONSIDER/PASS. Always pass playId from a prior screen row.',
      inputSchema: {
        type: 'object',
