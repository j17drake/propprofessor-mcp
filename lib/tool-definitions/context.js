  ...
  return [
    {
      name: 'player_context',
      description:
        'RESEARCH — get recent news, tweets, and a computed risk flag for a player. Use before placing a bet — if riskFlag is high, downgrade or skip. PITFALL: player name must match the odds-feed spelling. Use the exact name from a quick_screen row, not a nickname or partial name.',
      inputSchema: {
        type: 'object',
