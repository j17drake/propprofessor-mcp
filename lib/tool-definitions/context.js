...
function buildContextTools() {
  return [
    ...
    },
    {
      ...
      description:
        'Analyze line history across time windows (1h–48h) to detect sustained sharp-book consensus movement. Shows WHY a play ranks.',
      inputSchema: {
        type: 'object',
    ...
    },
    {
      name: 'all_slates',
      description:
        'Query multiple active leagues at once and return a consolidated ranked list. One call instead of 5-6 separate league screens.',
      inputSchema: {
        type: 'object',
    ...
    },
    {
      name: 'smart_money',
      description:
        'Mirror the Smart Money page: surface $ volume (sharp action) and per-side odds range per game/market, sorted by biggest sharp action first.',
      inputSchema: {
        type: 'object',
