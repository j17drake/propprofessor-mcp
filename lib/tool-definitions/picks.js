...
function buildPicksTools() {
  return [
    ...
    },
    {
      name: 'place_bet',
      description:
        'Validate a play and log it in ONE call. Runs validate_play, and if the verdict is BET/CONSIDER, logs the pick and returns a pickId for later settlement. If validate_play returns PASS, the bet is rejected up front with the reasons — nothing is logged.',
      inputSchema: {
        type: 'object',
        usage_example:
